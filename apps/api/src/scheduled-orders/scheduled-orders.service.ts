...
export class ScheduledOrdersService {
  ...
  async create(params: {
    ...
    const message = {
      ...
      twapPool: getAddress(dto.twapPool),
      twapWindowSec: dto.twapWindowSec,
      minPriceScaled: BigInt(dto.minPriceScaled),
      feeBps: dto.feeBps,
      nonce: BigInt(nonce),
    ...
    const created = await this.prisma.scheduledOrder.create({
      data: {
        ...
        maxSlices: dto.maxSlices,
        maxSlippageBps: dto.maxSlippageBps,
        twapPool: dto.twapPool,
        twapWindowSec: dto.twapWindowSec,
        minPriceScaled: dto.minPriceScaled,
        feeBps: dto.feeBps,
        nonce,
        signature,
...
include: { executions: { orderBy: [{ sliceIndex: 'asc' }, { executedAt: 'asc' }] } },
  ...
  private toDto(o: any): ScheduledOrderDto {
    return {
      ...
      twapPool: o.twapPool,
      twapWindowSec: o.twapWindowSec,
      minPriceScaled: o.minPriceScaled,
      feeBps: o.feeBps,
      nonce: o.nonce,
