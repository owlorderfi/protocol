...
- Found in src/LimitOrderRouter.sol [Line: 332](../src/LimitOrderRouter.sol#L332)

	```solidity
	    function setKeeperAuthorization(address keeper, bool authorized) external onlyOwner {
	```

- Found in src/LimitOrderRouter.sol [Line: 343](../src/LimitOrderRouter.sol#L343)
...
- Found in src/LimitOrderRouter.sol [Line: 376](../src/LimitOrderRouter.sol#L376)
...
- Found in src/LimitOrderRouter.sol [Line: 398](../src/LimitOrderRouter.sol#L398)

	```solidity
	    function pause() external onlyOwner {
	```

- Found in src/LimitOrderRouter.sol [Line: 404](../src/LimitOrderRouter.sol#L404)
...
- Found in src/LimitOrderRouter.sol [Line: 958](../src/LimitOrderRouter.sol#L958)
...
- Found in src/LimitOrderRouter.sol [Line: 650](../src/LimitOrderRouter.sol#L650)

	```solidity
	        uint256 fee = (received * order.feeBps) / 10_000;
	```

- Found in src/LimitOrderRouter.sol [Line: 803](../src/LimitOrderRouter.sol#L803)
...
- Found in src/LimitOrderRouter.sol [Line: 797](../src/LimitOrderRouter.sol#L797)

	```solidity
	            uint256 step = Math.mulDiv(order.amountPerSlice, order.minPriceScaled, 10 ** inDec);
	```

- Found in src/LimitOrderRouter.sol [Line: 798](../src/LimitOrderRouter.sol#L798)
...
- Found in src/LimitOrderRouter.sol [Line: 370](../src/LimitOrderRouter.sol#L370)
